...
const KEY = "reelpredict.state.v2";
...
export function AppStoreProvider({ children }: { children: ReactNode }) {
  ...
  const connectInstagram = useCallback((account: Partial<InstagramAccount>) => {
    ...
    const newAcc: InstagramAccount = {
      handle,
      followers: account.followers || 3500,
      avgReelViews: account.avgReelViews || 1800,
      avgEngagement: account.avgEngagement || 5.2,
      growth: account.growth || 12.5,
      consistency: account.consistency || 88,
