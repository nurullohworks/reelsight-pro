...
export const Route = createFileRoute("/analyze")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Meta & LiveDune Algoritmik Tahlil вЂ” REELPREDICT" },
          ...
          <>
            ...
            >
              ...
              <p className="mt-2 text-xs text-muted-foreground">
                {file ? `${(file.size / (1024 * 1024)).toFixed(1)} MB В· ${durationSec} soniya` : "Qo'llab-quvvatlanadi: MP4, MOV, WebM В· Maksimal hajm: 500MB"}
              </p>
              <input
                ref={inputRef}
                type="file"
